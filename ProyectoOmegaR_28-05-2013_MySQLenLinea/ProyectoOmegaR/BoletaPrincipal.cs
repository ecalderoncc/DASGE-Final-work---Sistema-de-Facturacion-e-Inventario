...
{
    public partial class BoletaPrincipal : Form
    {
        ...
        public BoletaPrincipal()
        {
            InitializeComponent();
        }
        public BoletaPrincipal(HomeOmega Refconten)
        {
            InitializeComponent();
        ...
        private void AgregarCliente() { // llama al form para que se cree un nuevo cliente
            MantenimientoCliente n_cliente = new MantenimientoCliente();
