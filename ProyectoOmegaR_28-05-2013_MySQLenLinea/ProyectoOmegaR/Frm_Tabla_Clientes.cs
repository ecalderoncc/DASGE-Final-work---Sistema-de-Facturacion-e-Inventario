...
namespace ProyectoOmegaR
{
    public partial class Frm_Tabla_Clientes : Form
    {
        ...
        Frm_Mantenimiento_Cliente MantenimientoCli;
        Frm_Boleta_Principal Nboleta;
        Frm_FacturaPrincipal NFactura;
        public Frm_Tabla_Clientes(Frm_Mantenimiento_Cliente disp)
        {
            InitializeComponent();
        ...
        public Frm_Tabla_Clientes(Frm_Home_Omega Refconten)
        {
            ...
            MantenimientoCli = new Frm_Mantenimiento_Cliente(Localcontene);
        ...
        public void setUpline(int ln, Frm_FacturaPrincipal Nfactura)
        {
            upline = ln;
            NFactura = Nfactura;
        }
